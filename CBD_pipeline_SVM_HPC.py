...
for kern in kernels:
    ...
    if enable_data_split:
        ...
        print('Overall DOR test score: %.2f' % dor_score(train_men_labels, male_predictions), '%.')
        ...
        print('Overall DOR test score: %.2f' % dor_score(train_female_labels, female_predictions), '%.')
